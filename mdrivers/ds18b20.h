...
#ifndef DRIVERS_DS18B20_H_
#define DRIVERS_DS18B20_H_
...
typedef int32_t (*ds18b20OneWireReset_t)(uint32_t to);
typedef int32_t (*ds18b20OneWireWrite_t)(uint8_t *buffer, uint16_t nbytes, uint32_t to);
typedef int32_t (*ds18b20OneWireRead_t)(uint8_t *buffer, uint16_t nbytes, uint32_t to);

typedef struct{

    ds18b20OneWireReset_t owReset;
    ds18b20OneWireWrite_t owWrite;
    ds18b20OneWireRead_t owRead;
}ds18b20Config_t;
//===========================================================================
